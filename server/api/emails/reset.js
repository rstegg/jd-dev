module.exports = (user, permalink_url) => `
<!doctype html>
...
<head>
  ...
  <title>Reset Your JawDrop Password</title>
  <!--[if !mso]>
      <!-- -->
...
<body style="-ms-text-size-adjust: 100%; -webkit-text-size-adjust: 100%;
 ...
 padding-bottom: 9px; padding-left: 18px;' valign="top">
                                <a href="https://www.jawdrop.io" style="mso-line-height-rule: exactly;
 -ms-text-size-adjust: 100%; -webkit-text-size-adjust: 100%; color: #2a2a2a;
 font-weight: normal; text-decoration: none" target="_blank" title="JawDrop is on-demand digital dental design center outsourcing with thousands of dental labs and technicians and with 3Shape Dental Designer.">
                                  <img align="none" alt="JawDrop is on-demand digital dental design center outsourcing with thousands of dental labs and technicians and with 3Shape Dental Designer." height="32" src="https://jawdrop.io/assets/media/jawdrop-logo.png" style="-ms-interpolation-mode: bicubic; border: 0; outline: none;
 ...
 padding-left: 0px; padding-top: 0; padding-bottom: 0; text-align:center;" valign="top">
                                <a class="" href="https://www.jawdrop.io" style="mso-line-height-rule:
 ...
 -ms-text-size-adjust: 100%; -webkit-text-size-adjust: 100%; min-width:100%;" width="100%">
                          <tbody class="mcnButtonBlockOuter">
                            <tr>
                              <td align="center" class="mcnButtonBlockInner" style="mso-line-height-rule:
 exactly; -ms-text-size-adjust: 100%; -webkit-text-size-adju st: 100%;
 ...
 padding-right:48px; padding-bottom:24px; padding-left:48px;" valign="middle">
                                        <a class="mcnButton " href=${permalink_url} style="mso-line-height-rule: exactly;
 ...
 #FFFFFF; text-transform:uppercase;" target="_blank" title="Reset JawDrop Password">Reset password</a>
                                      </td>
                                    </tr>
                                  </tbody>
                                </table>
 ...
 text-align: left; text-align: left; font-size: 14px; '>JawDrop is on-demand digital dental design center outsourcing with thousands of dental labs and technicians and with 3Shape Dental Designer.</p>
                              <div style="padding-bottom: 18px;">
                                <a href="https://www.jawdrop.io" style="mso-line-height-rule: exactly; -ms-text-size-adjust: 100%;
 -webkit-text-size-adjust: 100%; color: #f57153; font-weight: normal; text-decoration: none;
 font-size: 14px; color:#F57153; text-decoration:none;" target="_blank" title="Learn more about JawDrop">Learn More ❯</a>
                              </div>
                            </td>
                          </tr>
                        </table>
