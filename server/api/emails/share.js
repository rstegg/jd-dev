      ...
      <tbody>
        ...
        <tr>
          <td colspan="2" style="padding:30px 0;">
            ...
            <p style="margin:0 10px 10px 10px;padding:0;"><b>${fromName}</b> started a post on jawdrop!</p>
            ...
            <p>
              <a class="button-link" style="display:inline-block;text-decoration:none;padding:15px 20px;background-color:#70cf95;border:1px solid #70cf95;border-radius:3px;color:#FFF;font-weight:bold;" href=${url} target="_blank">Show Some Post!</a>
            </p>
          </td>
        </tr>
        <tr>
          <td colspan="2" style="padding:30px 0 0 0;border-top:1px solid #e9edee;color:#9b9fa5">
            This message was sent on jawdrop.io
          </td>
        </tr>
      </tbody>
    </table>
